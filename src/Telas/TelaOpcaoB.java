...
public class TelaOpcaoB extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaOpcaoB.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
