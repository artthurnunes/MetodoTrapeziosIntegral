...
public class TelaOpcaoD extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("<html>e<sup>3x</sup></html>");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaOpcaoD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
